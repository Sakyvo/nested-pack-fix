...
import com.sakyvo.nestedpackfix.forge189.pack.ArchiveRegistry;
import com.sakyvo.nestedpackfix.forge189.pack.CompatibleFileResourcePack;
import java.io.File;
...
final class ResourcePackScreenState extends Gui {
    ...
    private void installEntries() {
        ...
        AvailablePackFilter.remove(preparedAvailable, PackWarningKind.ILLEGAL);
